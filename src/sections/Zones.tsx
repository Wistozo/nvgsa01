...
const countries = [
  { name: 'Bénin',         code: 'BJ', capital: 'Cotonou',       role: 'Siège social',          isHQ: true  },
  { name: "Côte d'Ivoire", code: 'CI', capital: 'Abidjan',       role: 'Bureau de représentation', isHQ: false },
  { name: 'Togo',          code: 'TG', capital: 'Lomé',          role: 'Bureau de représentation', isHQ: false },
  { name: 'Burkina Faso',  code: 'BF', capital: 'Ouagadougou',   role: 'Partenaire commercial',    isHQ: false },
  { name: 'Cameroun',      code: 'CM', capital: 'Yaoundé',       role: 'Partenaire commercial',    isHQ: false },
  { name: 'Niger',         code: 'NE', capital: 'Niamey',        role: 'Partenaire commercial',    isHQ: false },
];
...
export default function Zones() {
  ...
  return (
    <section id="zones" className="relative section-padding bg-nvg-dark overflow-hidden">
      ...
      {/* Blobs */}
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-nvg-blue/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div className="flex-1 h-px bg-gradient-to-r from-nvg-orange/20 to-transparent" />
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-5">
            {t.zones.title}<span className="text-nvg-orange">{t.zones.titleHighlight}</span>
          </h2>
          ...
          {countries.map((c) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-white/40 leading-tight">{c.capital} · {c.role}</span>
              </div>
              {c.isHQ && <Navigation className="w-4 h-4 text-nvg-orange ml-1 flex-shrink-0" />}
            </div>
          ))}
        </div>
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-5 py-2.5 flex-wrap justify-center text-center">
            <MapPin className="w-4 h-4 text-nvg-orange flex-shrink-0" />
